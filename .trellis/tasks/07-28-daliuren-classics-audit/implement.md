...
- [x] 完成并归档 `07-28-daliuren-classics-evidence`。
- [x] 固定馆藏版本、卷册/影印页定位和证据等级。
- [x] 建立 source/rule/fixture schema、校验器和生成同步检查。
- [x] 为核心排盘、神煞、九宗门、64 课经、100 毕法、类神、本命行年、断课和应期建立能力清单。
- [x] 《断案》《存验》课例因无影印本保持 C；以三张 B 级《指南》影印课例登记独立预期，并覆盖重审、涉害两个九宗门分支。
