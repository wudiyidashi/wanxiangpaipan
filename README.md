...
- 奇门遁甲完整上线，支持自动时间起局、手动校盘、真太阳时和三种定局方式。
- 新增洛书九宫、宫位详情、本地规则裁决、事实与来源审计、冲突说明和应期观察窗口。
- 奇门焦点无法唯一定位时会明确显示诊断并暂停 AI 解读，完整盘面仍可继续查看。
- 奇门记录可保存、历史重开、独立统计清理和导入导出，并提供系统、综合和简要 AI 模板。
- 覆盖导入会先完成完整校验并隔离损坏记录，AI 对话和模板选择可稳定备份与恢复。
- 大六壬月将改为按北京时间的中气交接时刻精确切换，起课预览、结果页和 AI 解读使用同一套历法事实。
- 大六壬会固定保存起课来源时差；手工四柱须明确选择月将或通过民用时刻校验，旧盘换设备后也能稳定恢复原时刻。
- 大六壬天盘与四课增加完整性校验，并以三张《大六壬指南》独立手排课例校对；缺宫、乱序或课序/克向矛盾会明确失败，不再伪造本支或贵人。
- 大六壬贵人选择、落宫和实际顺逆已分开校正，四课三传、圆盘、结果页与 AI 共享一致的天盘乘将和地盘落将；旧盘不会被静默重排。
