...
void main() {
  group('ChangShengTable 长生/帝旺/墓/绝', () {
    test('金：长生巳 帝旺酉 墓丑 绝寅', () {
      expect(ChangShengTable.getStage(WuXing.jin, '巳'), ChangShengStage.changSheng);
    ...
    test('木：长生亥 帝旺卯 墓未 绝申', () {
      expect(ChangShengTable.getStage(WuXing.mu, '亥'), ChangShengStage.changSheng);
    ...
    test('火：长生寅 帝旺午 墓戌 绝亥', () {
      expect(ChangShengTable.getStage(WuXing.huo, '寅'), ChangShengStage.changSheng);
    ...
    test('水：长生申 帝旺子 墓辰 绝巳', () {
      expect(ChangShengTable.getStage(WuXing.shui, '申'), ChangShengStage.changSheng);
      expect(ChangShengTable.getStage(WuXing.shui, '子'), ChangShengStage.diWang);
    ...
    test('土：水土同宫（长生申 墓辰 绝巳）', () {
      expect(ChangShengTable.getStage(WuXing.tu, '申'), ChangShengStage.changSheng);
